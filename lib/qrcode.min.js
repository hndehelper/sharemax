// QRCode Generator for JavaScript (Offline, Zero Dependencies)
// MIT License - Kazuhiko Arase
var qrcode = function() {
    ...
    var QRUtil = {
        ...
        getMaskFunc: function(maskPattern) {
            switch (maskPattern) {
        ...
        create: function(text, container, size) {
            ...
            for (var r = 0; r < moduleCount; r++) {
                for (var c = 0; c < moduleCount; c++) {
                    ...
                    ctx.fillRect(Math.floor(c * cellSize), Math.floor(r * cellSize), w, h);
                }
            }
